...
## 项目路径
- 模型代码 (legacy clock_driven): D:\PYproject\SPAD\SNN_based_method\SNN.py
- 模型代码 (activation_based): D:\PYproject\SPAD\SNN_based_method\SNN_new.py
...
- SNN_new.py 使用 activation_based 新版 API (cupy 后端自动探测)
...
## 当前状态
- SNN.py: 正弦编码 + 等宽 SpikeBlock + Chunked 处理 + 置信度门控精修头, 已通过测试
...
- SNN_new.py: activation_based 版本, 与 SNN.py 功能一致, 神经元 step_mode='m'
