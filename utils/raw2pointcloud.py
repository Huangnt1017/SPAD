...
if __name__ == '__main__':
    ...
    # pc_rd = pc[indices, :]
    # plot_pc(pc_rd,'all')
    pc = read_pc(r'E:/essay/硕士/研一/SPAD数据/20250430dataset/2025-04-30-pc/B/2025-04-30_18-49-09_Delay-0_Width-200-10-12.txt')
    # pc = read_pc(r'E:/essay/硕士/研一/SPAD数据/20250825/number_pc/8/2025-08-25_18-08-36_Delay-0_Width-200-0.txt')
    # pc = read_pc(r'E:\\essay\\硕士\\CVPR\\data\\completedA.txt')  # 补全数据
    # pc = read_pc(r'E:\\essay\\硕士\\点云降采样+补全\\CVPR\\data\\raw_data\\A.txt')  # 原始数据
    # pc = read_pc(r'E:/essay/硕士/研一/SPAD数据/917/pc/2025-09-17_17-17-58_Delay-0_Width-2000-99-100.npy')
    # pc = read_pc(r'E:\\essay\\硕士\\点云降采样+补全\\CVPR\\data\\ds_data\\fps_sample\\A.txt')  # 降采样数据
    # pc5 = read_pc(r'E:/essay/硕士/研一/SPAD数据/20250430dataset/2025-04-30-dpc/G/2025-04-30_18-53-59_Delay-0_Width-200-32-34.txt')
    # pc = read_pc(r'E:\xwechat_files\wxid_14604684gq1j22_9f8d\msg\file\2025-11\1.txt')
    # pc = read_pc('E:/PyCharm Community Edition 2021.2.3/read_spad/HMC/D1.txt')
    # pc = read_pc('E:/essay/硕士/研一/SPAD数据/20260320/兔子/pc/2026-03-20_16-28-11_Delay-0_Width-200-2-3.txt')  # 兔子 大卫
